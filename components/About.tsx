    ...
    <div className='relative max-w-7xl mx-auto'>
      <div className='px-8'>
        <div className='grid gap-y-8 grid-cols-1 md:grid-cols-4'>
          ...
          <div className='col-span-3 sm:px-16'>
            ...
            <p className='text-lg text-neutral-800 dark:text-neutral-200 mb-4'>
              ...
              internship, where I worked on full-stack development projects
              using tools like React, Java, SQL, and AWS.
            </p>
            <p className='text-lg text-neutral-800 dark:text-neutral-200 mb-4'>
              ...
              tinkering with computers, I loved figuring out how things worked
              and how I could make them better. This curiosity eventually led me
              to programming, where I enjoyed the challenge of solving complex
              problems and the satisfaction of seeing my code come to life. That
              fascination sparked my decision to pursue software engineering
              where I have learned to create optimized, secure, and scalable
              solutions.
            </p>
            <p className='text-lg text-neutral-800 dark:text-neutral-200 mb-4'>
              ...
              particularly how businesses can leverage technology to drive
              growth and solve problems. That curiosity led me to the Ivey
              Business School, where I am now pursuing a dual degree in business
              and software engineering. My goal is to combine the technical
              expertise I&apos;ve gained with the strategic thinking and clear
              communication skills I am developing to create solutions that
